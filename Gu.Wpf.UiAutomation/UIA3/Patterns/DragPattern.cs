namespace Gu.Wpf.UiAutomation.UIA3.Patterns
{
    ...
    public class DragPattern : DragPatternBase<Interop.UIAutomationClient.IUIAutomationDragPattern>
    {
        ...
        public static readonly EventId DragCancelEvent = EventId.GetOrCreate(Interop.UIAutomationClient.UIA_EventIds.UIA_Drag_DragCancelEventId, "DragCancel");
        ...
        public static readonly EventId DragStartEvent = EventId.GetOrCreate(Interop.UIAutomationClient.UIA_EventIds.UIA_Drag_DragStartEventId, "DragStart");
