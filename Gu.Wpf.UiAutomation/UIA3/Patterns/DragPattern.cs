namespace Gu.Wpf.UiAutomation.UIA3.Patterns
{
    ...
    public class DragPattern : DragPatternBase<Interop.UIAutomationClient.IUIAutomationDragPattern>
    {
        ...
        public static readonly PropertyId DropEffectProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DragDropEffectPropertyId, "DropEffect");
        public static readonly PropertyId DropEffectsProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DragDropEffectsPropertyId, "DropEffects");
        public static readonly PropertyId IsGrabbedProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DragIsGrabbedPropertyId, "IsGrabbed");
        public static readonly PropertyId GrabbedItemsProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DragGrabbedItemsPropertyId, " GrabbedItems").SetConverter(AutomationElementConverter.NativeArrayToManaged);
