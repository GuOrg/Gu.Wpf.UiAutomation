namespace Gu.Wpf.UiAutomation.UIA3.Patterns
{
    ...
    public class DropTargetPattern : DropTargetPatternBase<Interop.UIAutomationClient.IUIAutomationDropTargetPattern>
    {
        ...
        public static readonly PropertyId DropTargetEffectProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DropTargetDropTargetEffectPropertyId, "DropTargetEffect");
        public static readonly PropertyId DropTargetEffectsProperty = PropertyId.Register(Interop.UIAutomationClient.UIA_PropertyIds.UIA_DropTargetDropTargetEffectsPropertyId, "DropTargetEffects");
